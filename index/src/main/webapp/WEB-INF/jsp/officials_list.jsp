    ...
    <div class="breadcrumb-box">
      <div class="am-container">
        <ol class="am-breadcrumb">
          <li><a href="<%=request.getContextPath()%>/dist/index.html">首页</a></li>
        ...
        <div class="am-g">
          <div class="am-u-md-6">
            <div class="our-company-text">
              ...
              <p>
                云适配(AllMobilize Inc.)
                是全球领先的HTML5企业移动化解决方案供应商，由前微软美国总部IE浏览器核心研发团队成员及移动互联网行业专家在美国西雅图创立，并获得了微软创投的扶持以及晨兴资本、IDG资本、天创资本等国际顶级风投机构的投资。
              </p>
              <p>
              ...
              <div class="am-g">
                <div class="am-u-md-6">
                  <div class="our-company-img">
                    <img src="<%=request.getContextPath()%>/dist/assets/images/about/ben.jpg" alt=""/>
                  </div>
                </div>
          ...
          <div class="am-g">
            <div class="am-u-md-3">
              <div class="our_mission--item">
                <div class="figure our_mission--item_media"><img
                        src="<%=request.getContextPath()%>/dist/assets/images/about/f02.jpg" alt=""></div>
            ...
            <div class="am-u-md-3">
              <div class="our_mission--item">
                <div class="figure our_mission--item_media"><img
                        src="<%=request.getContextPath()%>/dist/assets/images/about/f03.jpg" alt=""></div>
            ...
            <div class="am-u-md-3">
              <div class="our_mission--item">
                <div class="figure our_mission--item_media"><img
                        src="<%=request.getContextPath()%>/dist/assets/images/about/f04.jpg" alt=""></div>
            ...
            <div class="am-u-md-3">
              <div class="our_mission--item">
                <div class="figure our_mission--item_media"><img
                        src="<%=request.getContextPath()%>/dist/assets/images/about/f01.jpg" alt=""></div>
                <h3 class="our_mission--item_title">责任</h3>
                <div class="our_mission--item_body">
                  <p>
                    全球领先的HTML5解决方案供应商，安全高效解决企业移动化
            ...
            <div class="am-u-md-4">
              <div class="our-customer-say-box">
                <div class="our-customer-say-content">
                  <p>
                    光明网曾考虑过通过原生App来实现移动化，但是由于无法复用原始业务流程和数据就放弃了，直到选用了云适配整体解决方案后，可以很方便的在Enterplorer上使用一个帐号登录我们的系统，通过VPN随时进入内网。现在已经把我们的邮件系统，CMS内容管理系统都非常好的融合到了一起。</p>
                </div>
                <div class="our-customer-say-title">
                  <figure>
                    <img src="<%=request.getContextPath()%>/dist/assets/images/about/tz_pic_active.png" alt="">
                  </figure>
